  ...
  return (
    <main className="mt-16 flex flex-col gap-4">
      <h1 className="text-2xl md:text-4xl">
        It looks like there's a few more steps to getting your portfolio ready.
      </h1>
      <ul className="ml-4 list-disc">
        <li>
          Install{' '}
          <a className="text-blue-600 dark:text-blue-400" href="https://pnpm.io/installation">
            PNPM
          </a>
        </li>
        <li>
          ...
          <a
            ...
            href={process.env.VERCEL_BUTTON_REPO ?? ''}
          >
            source code
          </a>
        </li>
